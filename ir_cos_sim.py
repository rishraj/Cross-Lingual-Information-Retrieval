...
def main(hindi_query_file, trans_dict_file, bilingual_dict, word2vec_model):
	#read hindi query file
	f = open(hindi_query_file, 'r')
	read_file = f.read()	

	#read transliteration dictionary
	f = open(trans_dict_file, 'r')
	...
	with open(bilingual_dict) as f_obj:
	...
	#load word vectors
	model_hi_en = Word2Vec.load(word2vec_model)
